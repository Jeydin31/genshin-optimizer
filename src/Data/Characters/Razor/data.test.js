...
describe("Testing Razor's Formulas (Mabmab#6492)", () => {
  ...
  describe("with artifacts", () => {
    beforeEach(() => applyArtifacts(setupStats, [
      { hp: 4780, ...charObj.artifacts[0].substats }, // Flower of Life
      { atk: 311, ...charObj.artifacts[1].substats }, // Plume of Death
      { atk_: 38.7, ...charObj.artifacts[2].substats }, // Sands of Eon
      { physical_dmg_: 58.3, ...charObj.artifacts[3].substats }, // Goblet of Eonothem
      { atk_: 46.6, ...charObj.artifacts[4].substats }, // Circlet of Logos
